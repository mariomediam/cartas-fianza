        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Buscar y gestionar cartas fianza
            </p>
          </div>
        </div>
            ...
            <div className="mb-4">
              <h2 className="text-lg font-semibold text-gray-900">
                ...
                <span className="ml-2 text-sm font-normal text-gray-600">
                  ({searchResults.count}{" "}
                  {searchResults.count === 1 ? "resultado" : "resultados"})
                </span>
              </h2>
            </div>
                                      ...
                                      warranty.warranty_histories.length > 0 ? (
                                        <div className="space-y-6">
                                          ...
                                          <ol className="relative border-l border-gray-300 ml-3">
                                            {warranty.warranty_histories.map(
                                              (history, index) => (
                                                <li
                                                  key={history.id}
                                                  className="mb-6 ml-6"
                                                      ...
                                                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                                        ...
                                                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                                          ...
                                                          <div>
                                                            ...
                                                            <p className="text-sm font-medium text-gray-900">
                                                              {
                                                                history.validity_start
                                                              }{" "}
                                                              -{" "}
                                                              {
                                                                history.validity_end
                                                              }
                                                            </p>
                                                          </div>
                                                          <div>
