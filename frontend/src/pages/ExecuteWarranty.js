...
const ExecuteWarranty = () => {
  ...
  // Estados del formulario (solo los campos necesarios para ejecución)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Enviar al backend
      await api.post('/warranty-histories/ejecutar/', formDataToSend, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
      
      toast.success('Carta ejecutada correctamente');
      
      // Regresar a la página anterior con flag para refrescar
      navigate('/cartas-fianza', { state: { shouldRefresh: true } });
      
    } catch (error) {
      console.error('Error al ejecutar la carta:', error);
      ...
      if (error.response?.data?.error) {
        ...
        if (typeof errors === 'object') {
          ...
          toast.error('Error al ejecutar la carta');
        }
      } else {
        toast.error('Error al ejecutar la carta');
      }
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="relative flex items-start gap-3">
          ...
          <div className="flex-1 pr-12">
            <h1 className="text-2xl font-bold text-gray-900">Ejecutar carta</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-start">
              <span className="bg-white pr-4 text-lg font-semibold text-red-600">
                Ejecución
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={3}
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none bg-white"
              disabled={loading}
            />
          </div>
...
export default ExecuteWarranty;
