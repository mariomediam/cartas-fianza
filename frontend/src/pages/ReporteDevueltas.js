...
const ReporteDevueltas = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await api.get('/warranties/devueltas-por-periodo/', { params });
      setResults(response.data);

      if (response.data.count === 0) {
        toast.info('No se encontraron cartas devueltas en el período seleccionado');
      } else {
        toast.success(`Se encontraron ${response.data.count} carta(s) devuelta(s)`);
      }
    } catch (error) {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>Reporte de Cartas Fianza Devueltas</title>
        <style>
          @page {
            size: A4 landscape;
            margin: 10mm;
      ...
      <body>
        <div class="header">
          <h1>📤 REPORTE DE CARTAS FIANZA DEVUELTAS</h1>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th style="width: 8%;">Fecha Devolución</th>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Reporte de Cartas Fianza Devueltas
            </h1>
            <p className="text-gray-600 mt-1">
              Consulta las cartas fianza devueltas en un período específico
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSearch}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 focus:border-purple-500 focus:ring-purple-500"
                  required
                />
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                type="submit"
                disabled={loading}
                className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
                    <svg
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg
                  className="w-4 h-4 mr-2"
                  fill="none"
...
export default ReporteDevueltas;
