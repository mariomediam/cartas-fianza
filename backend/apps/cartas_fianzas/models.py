...
class UserProfile(models.Model):
    """
    Perfil de usuario extendido para agregar campos adicionales
    """
    ...
    can_manage_users = models.BooleanField(
        default=False,
        verbose_name='Puede administrar usuarios',
        help_text='Permite al usuario acceder al módulo de administración de usuarios'
    )
...
def create_user_profile(sender, instance, created, **kwargs):
    """Crear perfil cuando se crea un nuevo usuario"""
    if created:
